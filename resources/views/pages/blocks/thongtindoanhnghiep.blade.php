...
<div class="thongtin-content">
    ...
    <script type="text/javascript" src="{{ asset('assets/jquery-slider-master/js/jquery-1.9.1.min.js') }}"></script>
    <!-- use jssor.slider.mini.js (39KB) or jssor.sliderc.mini.js (31KB, with caption, no slideshow) or jssor.sliders.mini.js (26KB, no caption, no slideshow) instead for release -->
    <!-- jssor.slider.mini.js = jssor.sliderc.mini.js = jssor.sliders.mini.js = (jssor.core.js + jssor.utils.js + jssor.slider.js) -->
    <script type="text/javascript" src="{{ asset('assets/jquery-slider-master/js/jssor.core.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/jquery-slider-master/js/jssor.utils.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/jquery-slider-master/js/jssor.slider.js') }}"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 150px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 150px; overflow: hidden;">
            <div><img u="image" src="{{asset('assets/images/1.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/2.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/3.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/1.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/2.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/3.png')}}" /></div>
            <div><img u="image" src="{{asset('assets/images/1.png')}}" /></div>
